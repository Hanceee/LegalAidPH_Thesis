...
<style>
    ...
    .chat-list-container::-webkit-scrollbar-thumb:hover {
     ...
     @media (prefers-color-scheme: dark) {
        .chat-list-container::-webkit-scrollbar-thumb {
            background-color: rgba(255, 255, 255, 0.3); /* Thumb color in dark mode */
        }

        .chat-list-container::-webkit-scrollbar-thumb:hover {
            background-color: rgba(255, 255, 255, 0.5); /* Thumb color on hover in dark mode */
        }
    }
</style>
...
<div class="overflow-y-auto max-h-[calc(100vh-400px)] chat-list-container">
    ...
    <div x-data="{ open: false, deleteConfirmation: false }" class="absolute top-0 right-0">
        ...
        <div x-show="open" @click.away="open = false" class="absolute right-0 mt-2 w-48 bg-white border dark:bg-gray-900 dark:border-white border-gray-200 rounded-lg shadow-md z-50 origin-right bottom-1">
